...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, color: '#FF69B4', fontWeight: 'bold', marginBottom: 20, textAlign: 'center' },
  actionBtn: { backgroundColor: '#1e1e1e', padding: 20, borderRadius: 12, marginBottom: 15, borderLeftWidth: 4, borderLeftColor: '#FF69B4' },
  btnText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  lecCard: { backgroundColor: '#333', padding: 15, borderRadius: 10, marginRight: 10 },
  activeLec: { backgroundColor: '#442233', borderColor: '#FF69B4', borderWidth: 1 },
  rateRow: { marginBottom: 15 },
  rateLabel: { color: '#fff', marginBottom: 5 },
  starRow: { flexDirection: 'row' },
  starIcon: { fontSize: 30, marginRight: 5 },
  starActive: { color: '#FF69B4' },
  starInactive: { color: '#333' },
  submitBtn: { backgroundColor: '#FF69B4', padding: 15, borderRadius: 10, alignItems: 'center', marginTop: 20 },
  ...
  bigStat: { fontSize: 60, color: '#FF69B4', fontWeight: 'bold' },
  ...
  backText: { color: '#FF69B4', fontWeight: 'bold' }
});